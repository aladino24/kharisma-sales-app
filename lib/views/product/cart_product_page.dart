                                  ...
                                  Row(
                                    children: [
                                      Obx(() => Checkbox(
                                            ...
                                            onChanged: (value) {
                                              cartController.selectAll(cartController
                                                .isAllSelected.value.toString());
                                              // if (value == true) {
                                              //   // Calculate the sum of all prices
                                              //   totalCart.value = cartController
                                              //       .cartProductList
                                              //       .fold(
                                              //           0,
                                              //           (sum, cartProduct) =>
                                  ...
                                  ? ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        return GetBuilder<CartController>(
                                          ...
                                          builder: (controller) {
                                            final price = cartController.prices[cartProduct.product!.productTmplId!];
                                                        ...
                                                        Checkbox(
                                                          ...
                                                          onChanged: (value) async {
                                                             // cartController.fetchCartProduct();
                                                              ...
                                                              //       cartProduct.totalPrice!);
                                                              // }
                                                              await cartController.selectedCheckbox(cartProduct.uuid!, cartProduct.isSelected.toString());
                                                          },
                                                        ),
                                                        Container(
                                                          width: 80,
                            ...
                            Container(
                              child: Column(
                                children: [
                                  ...
                                  //             symbol: 'Rp ',
                                  //             decimalDigits: 0,
                                  //           ).format(cartController.total_bayar.value),
