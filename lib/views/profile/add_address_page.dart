                    ...
                    Container(
                      ...
                      child: Form(
                        ...
                        child: RefreshIndicator(
                          onRefresh: () async {
                            alamatKirimController.recipientNameController.text = "";
                            alamatKirimController.recipientPhoneController.text = "";
                            alamatKirimController.recipientAddressController.text = "";
                            alamatKirimController.recipientKodePosController.text = "";
                                  ...
                                  child: alamatKirimController.isLoading.value ? Center(child: CircularProgressIndicator(),) : ElevatedButton(
                                    ...
                                    onPressed: () {
                                      if (_formKey.currentState!.validate()) {
                                        alamatKirimController.createNewAddress();
                                      }
